export const config = {
  ...
  SLOT_LIST: [
    ...
    // 这样配置的话，就会每次随机选一句话发送
    {"keyword": "your_msg", contents: "老婆对不起，就跟你给我写的信一样，我们在一起太不容易了，我们都更想珍惜我们的每一天，未来的某一天我们要一起建立一个属于我们的家。你对我的所有的好我都记得，你说我脾气大，那就幸苦一下老婆以后就对我严厉一点，我再大脾气你就直接捶我，事实证明你锤我我就没脾气了。现在对于我来说更多的是责任感，这也是对男人来说最重要的一点，我们现在过的不好，我内心跟你说的一样我很自责，我想要我们过好，我会好好努力的。我爱你我们和好好不好"},
  ],
